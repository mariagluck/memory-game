import doggy from "./assets/images/karsten-winegeart-dog.jpg";
import image_1 from "./assets/images/alejandro-contreras_flamingo.jpg";
import image_2 from "./assets/images/andy-holmes-D6TqIa-tWRY-unsplash.jpg";
import image_3 from "./assets/images/david-clode-7_bird.jpg";
import image_4 from "./assets/images/edgar-nKC772R_cat.jpg";
import image_5 from "./assets/images/gilles-rolland-monnet-koala.jpg";
import image_6 from "./assets/images/hans-jurgen-mager-lion.jpg";
import image_7 from "./assets/images/ricardo-frantz_pavoReal.jpg";
import image_8 from "./assets/images/laura-college_hirsch.jpg";
...
export function createCard(img) {
  ...
  let card = elemCreator("div", {
    class: "flip-card",
    id: "card",
    dataURL: img
  });
  let cardInner = elemCreator("div", {
    class: "flip-card-inner",
    id: "card-inner"
  });
  let cardFront = elemCreator("div", {
    class: "flip-card-front"
  });
  let imgFront = elemCreator("img", {
    src: doggy,
    alt: "avatar",
    style: "width:100%;height:100%;"
  });
  let cardBack = elemCreator("div", {
    class: "flip-card-back"
  });
  let imgBack = elemCreator("img", {
    src: img,
    alt: "avatar",
    style: "width:100%;height:100%"
  });
